...
class __TwigTemplate_9ceb8cc8c6da25a5aa9df795137decca extends Template
{
...
\t\t";
        ...
        yield "
\t\t<caption >
\t\t\t<h1 class=\"text-center\"><i class=\"fa-solid fa-circle-plus\"></i>";
        // line 10
...
\t\t";
        // line 13
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "icone", [], "any", false, false, false, 13), 'row');
        yield "
\t\t";
        // line 14
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "description", [], "any", false, false, false, 14), 'row');
        yield "
\t\t";
        // line 15
...
";
    ...
    {
        return array (  164 => 22,  151 => 21,  137 => 18,  131 => 15,  127 => 14,  123 => 13,  119 => 12,  114 => 10,  109 => 8,  105 => 6,  92 => 5,  78 => 3,  65 => 2,  42 => 1,);
    }
...
\t\t{{ form_start(form) }}
\t\t<caption >
\t\t\t<h1 class=\"text-center\"><i class=\"fa-solid fa-circle-plus\"></i>{{title}}</h1>
\t\t</caption>
\t\t{{ form_row(form.nom) }}
\t\t{{ form_row(form.icone) }}
