...
\t\t\t\t<a href=\"";
            // line 12
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_commandes_liste-commandes-client", ["id" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "user", [], "any", false, false, false, 12), "id", [], "any", false, false, false, 12)]), "html", null, true);
            yield "\">
\t\t\t\t\t<i class=\"fa-solid fa-clipboard-list\"></i>Mes commandes / tickets</a>
\t\t\t</div>
...
\t\t\t\t\t<span id=\"cart-count\" class=\"cart-badge\">";
        // line 34
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("totalItems", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["totalItems"]) || array_key_exists("totalItems", $context) ? $context["totalItems"] : (function () { throw new RuntimeError('Variable "totalItems" does not exist.', 34, $this->source); })()), 0)) : (0)), "html", null, true);
        yield "</span>
\t\t\t\t</span>
...
";
    ...
    {
        return array (  146 => 45,  123 => 44,  110 => 34,  104 => 31,  101 => 30,  97 => 28,  93 => 26,  85 => 22,  83 => 21,  76 => 17,  68 => 12,  62 => 9,  57 => 6,  55 => 5,  49 => 1,);
    }
