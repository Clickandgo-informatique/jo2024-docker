...
\t\t\t";
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["sports"]) || array_key_exists("sports", $context) ? $context["sports"] : (function () { throw new RuntimeError('Variable "sports" does not exist.', 18, $this->source); })()));
...
\t\t\t\t\t\t<a href=\"";
            // line 21
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_sports_edit", ["slug" => CoreExtension::getAttribute($this->env, $this->source, $context["d"], "slug", [], "any", false, false, false, 21)]), "html", null, true);
            yield "\" class=\"btn-action btn-open \">
...
\t\t\t\t\t<td>";
            // line 26
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["d"], "emoji", [], "any", false, false, false, 26), "html", null, true);
            yield "
\t\t\t\t\t\t";
            // line 27
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["d"], "intitule", [], "any", false, false, false, 27), "html", null, true);
            yield "</td>
\t\t\t\t\t<td>
...
";
    ...
    {
        return array (  189 => 42,  176 => 41,  162 => 37,  155 => 35,  153 => 34,  141 => 27,  137 => 26,  129 => 21,  125 => 19,  120 => 18,  107 => 8,  103 => 6,  90 => 5,  78 => 3,  65 => 2,  42 => 1,);
    }
...
\t\t\t\t<tr>
\t\t\t\t\t<td class=\"cell-actions text-center\">
\t\t\t\t\t\t<a href=\"{{path('app_sports_edit',{slug:d.slug})}}\" class=\"btn-action btn-open \">
\t\t\t\t\t\t\t<i class=\"fa-solid fa-pen-to-square\"></i>
\t\t\t\t\t\t</a>
