...
class __TwigTemplate_1fbc7665246c09df590a31c9f8f5f443 extends Template
{
...
\t\t<i class=\"fa-solid fa-list\"></i>Revenir à la liste d'offres</a>
\t<h1 class=\"text-center\">
\t\t<i class=\"fa-solid fa-cart-shopping\"></i>Mon panier</h1>

\t";
        // line 13
        yield "\t<div class=\"ajax-reloaded-data\">
\t\t";
        // line 14
        yield Twig\Extension\CoreExtension::include($this->env, $context, "_partials/_cart-items.html.twig");
        yield "
\t</div>
\t";
        // line 17
...
\t<a href=\"";
        // line 18
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_commandes_ajout");
        yield "\" class=\"btn btn-primary\">
\t\t<i class=\"fa-solid fa-circle-check\"></i>Valider le panier</a>
...
";
    ...
    {
        return array (  180 => 25,  167 => 24,  141 => 22,  126 => 18,  123 => 17,  118 => 14,  115 => 13,  107 => 7,  104 => 6,  91 => 5,  79 => 3,  66 => 2,  43 => 1,);
    }
...
\t{# Lignes panier :Contenu requête dynamique en Ajax #}
\t<div class=\"ajax-reloaded-data\">
\t\t{{include('_partials/_cart-items.html.twig')}}
\t</div>
\t{# Fin contenu requête Ajax #}

\t<a href=\"{{path('app_commandes_ajout')}}\" class=\"btn btn-primary\">
\t\t<i class=\"fa-solid fa-circle-check\"></i>Valider le panier</a>
